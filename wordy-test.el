...
(ert-deftest unknown-operation ()
  (should-error (answer "What is 52 cubed?") :type 'unknown-operation))


(ert-deftest non-math-question ()
  (should-error (answer "Who is the President of the United States?") :type 'unknown-operation))


(ert-deftest reject-problem-missing-an-operand ()
  (should-error (answer "What is 1 plus?") :type 'syntax-error))


(ert-deftest reject-problem-with-no-operands-or-operators ()
  (should-error (answer "What is?") :type 'syntax-error))


(ert-deftest reject-two-operations-in-a-row ()
  (should-error (answer "What is 1 plus plus 2?") :type 'syntax-error))


(ert-deftest reject-two-numbers-in-a-row ()
  (should-error (answer "What is 1 plus 2 1?") :type 'syntax-error))
...
(ert-deftest reject-prefix-notation ()
  (should-error (answer "What is plus 1 2?") :type 'syntax-error))
